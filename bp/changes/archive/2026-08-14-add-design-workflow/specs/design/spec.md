...
<!--
  Behavioral contract for the design workflow track. Produced by the planner agent.
  Describes WHAT the system does, not HOW.

  On archive:
  - ADDED -> appended to bp/specs/design/spec.md (new domain)
-->

> Change: add-design-workflow | Domain: design
...
- **AND** the corresponding skill files exist under `.omp/skills/` and `.agent/skills/` and `.agents/skills/`
