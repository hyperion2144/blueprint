...
- **Integrations** (`src/integrations/`): Platform-specific file generators (OMP, Claude Code, .agents, .dsh)
...
| `integrations` | OMP, Claude Code, `.agents` (agent + codex), `.dsh`, Pi, OpenCode platform generators |
