...
| specwf/changes/fix-state-machine-adhoc/proposal.md | 创建 | Proposal 文档 |
| specwf/changes/fix-state-machine-adhoc/design.md | 创建 | Design 文档 |
| specwf/changes/fix-state-machine-adhoc/tasks.md | 创建 | Tasks 文档 |
