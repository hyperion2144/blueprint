...
<!--
  Orchestrator instructions for `bp continue [name]`.
  This command checks artifact existence and suggests the next step.
  It does NOT execute the next step - it only recommends.

  This is the v2 replacement for the state machine.
