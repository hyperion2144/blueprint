...
function cleanupStaleFiles(baseDir: string, generatedPaths: string[]): void {
  ...
  const v2Steps: Record<string, true> = { init: true, roadmap: true, propose: true, plan: true, apply: true, review: true, archive: true, continue: true, ff: true, loop: true, refactor: true };
