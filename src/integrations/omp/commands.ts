...
export const STEP_DEFS: CommandDef[] = [
  ...
  { step: 'milestone', name: 'bp:milestone', description: 'Milestone management — switch/create milestones, set current phase', usesAgent: false, agents: [], argumentHint: '[milestone-id]' },
  ...
  { step: 'adhoc', name: 'bp:adhoc', description: 'Create adhoc change — independent change unrelated to milestone/phase', usesAgent: false, agents: [], argumentHint: '[change-name]' },
  { step: 'plan', name: 'bp:plan', description: 'Change design — technical design + task breakdown + delta-specs', usesAgent: true, agents: ['planner'], argumentHint: '[change-name]' },
  { step: 'apply', name: 'bp:apply', description: 'Code implementation — TDD RED→GREEN→REFACTOR', usesAgent: true, agents: ['executor'], argumentHint: '[change-name]' },
  { step: 'review', name: 'bp:review', description: 'Triple review — spec/quality/goal reviews in parallel', usesAgent: true, agents: ['reviewer'], argumentHint: '[change-name]' },
  { step: 'archive', name: 'bp:archive', description: 'Verify & archive — run checks, then delta-spec merge + directory move + state update', usesAgent: false, agents: [], argumentHint: '[change-name]' },
  { step: 'ship', name: 'bp:ship', description: 'Ship — create PR + update state / release tag', usesAgent: false, agents: [] },
  { step: 'continue', name: 'bp:continue', description: 'Auto-advance — read STATE and route to next step', usesAgent: false, agents: [], argumentHint: '[change-name] [--auto]' },
  { step: 'audit', name: 'bp:audit', description: 'Human UAT verification — generate uat.md, interactive testing, adhoc fixes', usesAgent: false, agents: [], argumentHint: '[change-name|phase-id|milestone-id]' },
  ...
  { step: 'proposal', name: 'bp:proposal', description: 'Fill change proposal — intent, scope, approach, must-haves, non-goals', usesAgent: false, agents: [], argumentHint: '[change-name]' },
  ...
  { step: 'fix-plan', name: 'bp:fix-plan', description: 'Fix design — correct architecture/approach based on review BLOCKERs', usesAgent: true, agents: ['planner'], argumentHint: '[change-name]' },
  { step: 'fix-apply', name: 'bp:fix-apply', description: 'Fix implementation — wave-based dispatch for review finding fixes', usesAgent: true, agents: ['executor'], argumentHint: '[change-name]' },
];
