...
FAIL example: DS-N lists only Responsibility + Key Interfaces with no Requirements, Constraints, or Acceptance Criteria — there is no acceptance bar to verify against.
