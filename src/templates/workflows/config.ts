...
export function getConfigSkillTemplate(): SkillTemplate {
  return {
    name: 'bp-config',
    description: 'Interactive configuration wizard — set workflow, model, conventions',
    instructions,
  };
}

export function getConfigCommandTemplate(): CommandTemplate {
  return {
    description: 'Interactive configuration wizard — set workflow, model, conventions',
    category: 'Setup',
    tags: ['bp', 'config', 'settings', 'models', 'profile'],
