...
2. Call the tool it specifies. Set the sub-agent's prompt to:
   ...
   - Read: requirements.md, roadmap.md (this phase), research.md, design.md, tasks.md (spec_ref fields tell which domains to load), bp/conventions/coding-standards.md
