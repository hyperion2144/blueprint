...
<!-- ENGINEERING-CONSTRAINT: mode selection — normal vs fix mode structural contract -->
...
\`\`\`
## Fix Mode (Re-review)
<!-- ENGINEERING-CONSTRAINT: fix mode protocol — issue state machine and verification process -->
...
### Process each issue:
<!-- ENGINEERING-CONSTRAINT: fix mode verification process — structural protocol for [~] → [x] verification -->
